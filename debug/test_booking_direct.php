...
echo "<h2>🧪 Test Booking Direct</h2>";
...
try {
    ...
    foreach ($rooms as $room) {
        ...
        if ($room['Status'] === 'Available') {
            ...
            echo "<input type='hidden' name='book_room' value='{$room['RoomID']}'>";
            echo "<button type='submit' style='background: #28a745; color: white; border: none; padding: 5px 10px; border-radius: 3px;'>Book This Room</button>";
            echo "</form>";
        }
        echo "</td>";
        echo "</tr>";
    ...
    // 3. Test đặt phòng trực tiếp
    if (isset($_POST['book_room'])) {
        $room_id = (int)$_POST['book_room'];
        ...
        try {
            ...
            $total_amount = $room_info['PricePerNight'] * 2; // 2 nights
            ...
            echo "<div style='background: #e2e3e5; border: 1px solid #d6d8db; border-radius: 5px; padding: 15px; margin: 10px 0;'>";
            echo "<h4>✅ Reservation Created:</h4>";
            ...
            echo "<p><strong>Payment Status:</strong> Pending</p>";
            echo "</div>";
            ...
            echo "<div style='background: #e2e3e5; border: 1px solid #d6d8db; border-radius: 5px; padding: 15px; margin: 10px 0;'>";
            echo "<h4>🔄 Room Status Updated:</h4>";
            echo "<p><strong>Room ID:</strong> $room_id</p>";
            ...
            echo "<h4>✅ Booking Completed Successfully!</h4>";
    ...
    echo "<h3>4. Test hiển thị trạng thái</h3>";
    ...
    echo "<p><a href='debug_reserved_display.php' style='background: #007bff; color: white; padding: 10px 20px; text-decoration: none; border-radius: 5px;'>→ Debug Reserved Display</a></p>";
